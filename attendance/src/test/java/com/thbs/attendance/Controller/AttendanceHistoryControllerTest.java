...
public class AttendanceHistoryControllerTest {
    ...
    public void testUpdateAttendance() {
        ...
        // Mock behavior
        List<EmployeeAttendanceDTO> attendanceDetails = new ArrayList<>();
        when(attendanceService.getAttendanceDetails(batchID, courseId, date, type)).thenReturn(attendanceDetails);

        // Call the controller method
        ResponseEntity<?> responseEntity = attendanceHistoryController.updateAttendance(batchID, courseId, date, type);
