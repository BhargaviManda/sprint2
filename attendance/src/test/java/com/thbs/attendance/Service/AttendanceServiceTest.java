...
class AttendanceServiceTest {
    ...
    void testGetAvailableSlots() {
        // Test data
        Attendance attendance1 = new Attendance(1L, 1L, 1L, Collections.singletonList(new AttendanceDetail("2024-05-12", "First Half", "Present")));
        Attendance attendance2 = new Attendance(1L, 1L, 2L, Collections.singletonList(new AttendanceDetail("2024-05-12", "Second Half", "Present")));
        when(attendanceRepository.findByBatchIdAndCourseId(anyLong(), anyLong())).thenReturn(Arrays.asList(attendance1, attendance2));

        // Call method
        List<String> result = attendanceService.getAvailableSlots(1L, 1L, "2024-05-12");
